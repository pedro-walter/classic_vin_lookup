...
tri_50_62_code = {'1950':  (r'^(\d{3,4})(n)$',         (0, 100, 9999),    'From 100N'),
                  '1951':  (r'^(\d{3,5})(na)$',        (0, 101, 15808),   '101NA, 15808NA'),
                  '1952':  (r'^([3,4]\d{4,4})$',       (0, 32303, 44134), '32303, 44134'),
                  '1954':  (r'^([4,5]\d{4,4})$',       (0, 44135, 56699), '44135, 56699'),
                  '1955':  (r'^([5,6,7]\d{4,4})$',     (0, 56700, 70929), '56700, 70929'),
                  '1956a': (r'^([7,8]\d{4,4})$',       (0, 70930, 82799), '70930, 82799 (A) then 0100 - 0944 (B)'),
                  '1956b': (r'^(0\d{3,3})$',           (0, 100, 944),     'Above then 0100 - 0944 (B)'),
                  '1957':  (r'^(0\d{3,5})$',           (0, 945, 11115),   '0945, 011115'),
                  '1958': (r'^(0[1,2]\d{4,4})$',       (0, 11116, 20075), '011116, 020075'),
                  '1959': (r'^(02\d{4,4})$',           (0, 20076, 29363), '020076, 029363'),
                  '1960a': (r'^(0[2,3]\d{4,4})$',      (0, 29364, 30424), '029364, 030424 then D101 - D7726'),
                  '1960b': (r'^(d)(\d{3,4})$',         (1, 101, 7726),    'Above then D101 - D7726'),
                  '1961': (r'^(d)([7,8,9,1]\d{3,4})$', (1, 7727, 15788),  'D7727 - D15788'),
                  '1962': (r'^(d)([1,2,3]\d{4,4})$',   (1, 15789, 30000), 'D15789 on')}
